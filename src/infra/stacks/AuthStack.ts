...
import { UserPool, UserPoolClient,CfnUserPoolGroup,CfnIdentityPool,CfnIdentityPoolRoleAttachment } from 'aws-cdk-lib/aws-cognito';
...
export class AuthStack extends Stack {
    ...
    private createIdentityPool(){
        this.identityPool = new CfnIdentityPool(this,'NoteIdentityPool',{
        ...
        new CfnOutput(this, 'NoteIdentityPoolId', {
